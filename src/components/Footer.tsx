      ...
      <div className="container mx-auto px-4">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-display text-primary text-lg">
                Astrolight by Snehaa
              </span>
            </div>
            <p className="font-sans-clean text-sm text-foreground/60 mb-4">
              Guiding individuals toward clarity, positivity, and transformation
              through astrology and holistic healing.
            </p>
            <div className="flex items-center gap-4">
              <a
                href="https://www.instagram.com/astrolightbysneha/"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/share/14VWRhykTr5/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-foreground/60 hover:text-primary transition-colors"
              >
            ...
            <div className="space-y-2">
              {[
                ...
                <Link
                  key={link.to}
                  to={link.to}
                  className="block font-sans-clean text-sm text-foreground/60 hover:text-primary transition-colors"
                >
                  {link.label}
                </Link>
              ))}
          ...
          <div>
            ...
            <div className="space-y-2">
              {[
                ...
                <p
                  key={s}
                  className="font-sans-clean text-sm text-foreground/60"
                >
                  {s}
                </p>
              ))}
        ...
        <div className="border-t border-primary/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="font-sans-clean text-xs text-muted-foreground">
            © {new Date().getFullYear()} Astrolight by Snehaa. All rights
            reserved.
          </p>
          <p className="font-sans-clean text-xs text-muted-foreground">
